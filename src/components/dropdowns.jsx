    ...
    <div className="infowrapper">
      <details>
        ...
        <p>
          ...
          want, whenever you want – all for one low monthly price. There's
          always something new to discover and new TV shows and movies are added
          every week!
        </p>
      </details>
      <details>
      ...
      <details>
        ...
        <p>
          ...
          consoles. You can also download your favorite shows with the iOS or
